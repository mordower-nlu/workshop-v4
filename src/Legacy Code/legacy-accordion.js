    ...
    function primaryScrollHelper(caller)
    {
    ...
    var primaryToggle = function primaryClickCallback() {
    ...
    var nestedToggle = function nestedCallback() {
